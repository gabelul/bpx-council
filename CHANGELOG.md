...
* Auto-discovered project config rejects CLI/tmux routes, custom URLs, and persona prompts. Unknown keys and configured image paths fail validation. install --with-hook is no longer supported.
